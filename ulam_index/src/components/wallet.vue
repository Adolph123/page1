...
<!--      <div-->
<!--        style="background:linear-gradient(to bottom right, #dd8fff , #9a55ff);width:100%;color:#000;padding:15px;box-sizing:border-box;margin-top:-2px;">-->
...
<!--          &lt;!&ndash;<p style="font-size:14px;">≈ ￥0.93&ndash;&gt;-->
<!--          &lt;!&ndash;&lt;!&ndash;<span style="color:#777575;float: right;">累计收益￥0.9</span>&ndash;&gt;&ndash;&gt;-->
<!--          &lt;!&ndash;</p>&ndash;&gt;-->
<!--        </div>-->
<!--        <div v-if="yanxian">-->
<!--          <p style="font-size:26px;margin-top:8px;"><span style="font-size:16px;color:#fff">******</span></p>-->
<!--          &lt;!&ndash;<p style="font-size:14px;">≈ ￥****&ndash;&gt;-->
<!--          &lt;!&ndash;&lt;!&ndash;<span style="color:#777575;float: right;">累计收益￥****</span>&ndash;&gt;&ndash;&gt;-->
<!--          &lt;!&ndash;</p>&ndash;&gt;-->
<!--        </div>-->
<!--      </div>-->
...
<!--        name: "wallet",-->
<!--        components: {-->
<!--            Cell, Group, XHeader, XInput, XButton, Toast, Confirm, Actionsheet, Loading, InlineLoading,bottomNav-->
<!--        },-->
<!--        data() {-->
<!--            return {-->
<!--                startY: '',    //保存touch时的Y坐标-->
...
<!--                //主网钱包ip-->
<!--                that.axios.post('http://39.98.70.159:5004/ulam_wallet',-->
<!--                    {-->
<!--                        "mobile": parseInt(a),-->
<!--                        "password": b-->
<!--                    }).then(response => {-->
...
<!--                }-->
<!--                that.axios.get('http://39.101.219.128:5100/token_price_all').then(response => {-->
<!--                    //  获取到的全都是人民币价格-->
  ...
  <div style="background:#fff;" :style="{ height: bodyHeight + 'px' }" class="lala">
    ...
    <Scroll class="main-content">
      <div>
        <div style="width:100%;">
          <div class="xzhu">
            <div style="height:70px;display: flex;justify-content: flex-end;line-height: 70px;align-items: center">
<!--              <img @click="gobacks" src="@/assets/2_03.png" alt="" style="display: block;width: 26px;height: 26px" >-->
        ...
        <div v-if="xkj" class="dai1">
          ...
          <div style="padding:20px 0;box-sizing:border-box;">
            <div class="cz1 backcolors" v-on:click="addkj">添加代理</div>
          </div>
        </div>
    ...
    <popup v-model="czkj" height="460px" is-transparent>
      ...
      >
        ...
        <div style="padding:15px 30px;box-sizing:border-box;">
          ...
          <div class="loginke">
            <input type="number" class="login" v-model="shu" placeholder="输入添加代理数量"/>
          </div>
        </div>
        ...
        methods: {
            ...
            diaoge1() {
                ...
                that.axios
                    ...
                    .post("https://pool.ulam.top/search_miner_tg", {
...
//矿机数不足
            ...
            diaoqu() {
                ...
                that.axios.post( 'https://pool.ulam.top/ulam_wallet',
                    {
                        "mobile": parseInt(a),
                        "password": b
                    }).then(response => {
