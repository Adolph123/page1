<template>
  <div id="rapbox" :style="{minHeight:height+'px'}">
    ...
    <!--测试下拉刷新             -->
    <div  v-if="searchs" style="display: flex;justify-content: center;align-items: center;height: 50px;width: 100vw">
...
<!--                  {{ moveState === 0 ? '下拉即可刷新...' : '释放即可刷新...' }}-->
      ...
      <scroll class="main-content" :style="{height: height-80 + 'px' }" :listenScroll="listenScroll" :probeType="probeType" :pullup="pullup"  ref="scroll" @scroll="scrollss"
              @scrollToend="scrollToend"  id="scroll">
...
<!--                {{reminds.remindCount}}条新消息-->
    ...
    <backColor v-if="show1">
      <div v-show="show1"
           style="position: fixed;top: 20vh;width: 82%;left: 6%;background: #fff;padding: 10px;border-radius: 6px;">
...
<!--    </confirm>-->
    ...
    <div>
      ...
      <div v-if="rbxian ==3" class="bao3" @touchmove.prevent>
        ...
        <div style="position:absolute;top:25%;color:#fff;width:100%;text-align:center;font-size:20px;font-weight:700;">
          <p v-on:click="qing1" style="">- 领取详情 -</p>
        </div>
    ...
    <!--查看头像弹窗-->
      <div style="position: relative;z-index: 999999999999999999999999999">
    ...
    export default {
        ...
        mounted(){
            ...
            if (!message) {
                ...
                console.log(JSON.parse(localStorage.getItem('community')),'@@@@@@@@@@@@@@@@@@@')
